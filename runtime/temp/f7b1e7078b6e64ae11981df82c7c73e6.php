<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\public/../application/index\view\user\news.html";i:1541292742;s:90:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\index\view\layout\default.html";i:1540896091;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<body class="gray_bg">
	<div class="warp">
		...
		<div class="container">
			...
			<div class="main news_inf">
				<div class="back_div">
					<a onclick="javascript:history.back(-1);"><img src="/kewei/images/back_img.png" alt=""/></a>
				</div>
				<div class="news_miaoshu">
					<h2 class="f18"><?php echo $arr['name']; ?></h2>
					<div class="newp_div">
...
//
//
//                 src = "http://www.wecanwell.com/" + src;
//
//
//
//

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:99:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\public/../application/admin\view\category2\add.html";i:1541142742;s:90:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\admin\view\layout\default.html";i:1536636086;s:87:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\admin\view\common\meta.html";i:1536636086;s:89:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\admin\view\common\script.html";i:1536636086;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-type" class="control-label col-xs-12 col-sm-2"><?php echo __('所属类别'); ?>:</label>
    ...
    <div class="form-group">
        <label for="c-nickname" class="control-label col-xs-12 col-sm-2"><?php echo __('链接地址'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-nickname" data-rule="required" class="form-control" name="row[nickname]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="c-keywords" class="control-label col-xs-12 col-sm-2"><?php echo __('副标题'); ?>:</label>
        <div class="col-xs-12 col-sm-8">

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:99:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\public/../application/admin\view\category7\add.html";i:1541304333;s:90:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\admin\view\layout\default.html";i:1536636086;s:87:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\admin\view\common\meta.html";i:1536636086;s:89:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\admin\view\common\script.html";i:1536636086;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-name" data-rule="required" class="form-control editor" name="row[name]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="c-image" class="control-label col-xs-12 col-sm-2"><?php echo __('图片'); ?>:</label>
        <div class="col-xs-12 col-sm-8">

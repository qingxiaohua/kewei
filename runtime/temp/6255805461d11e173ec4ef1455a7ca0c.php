<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:101:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\public/../application/index\view\user\contact_kw.html";i:1541306061;s:90:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\index\view\layout\default.html";i:1541305992;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<style>body { margin: 0; font: 13px/1.5 "Microsoft YaHei", "Helvetica Neue", "Sans-Serif";}
    .my-map { margin: 0 auto; width: 1200px; height:330px; }
		...
		<div class="container">
			<div class="main link_way">
			    ...
			    <div class="contact_div">
			    	...
			    	<div class="contact_child red lf"> 
			    		<h3><?php echo $arr['name']; ?></h3>
			    		<p class="addr_p"><?php echo $arr['flag']; ?></p>
			    		<p class="addr_p1"><?php echo $arr['nickname']; ?></p>
			    	</div>
			    	<div class="contact_child blue1 lt">
			    		<h3>商务联系</h3>
			    		<p>商务合作：<?php echo $arr['diyname']; ?></p>
			    		<p>媒体合作：<?php echo $arr['image']; ?></p>
    ...
    <script>
        !function () {
            ...
            var infoWindow, map, level = 18,
                center = { lng: 116.481704, lat: 39.977032 },
                features = [{ type: "Marker", name: "北京可为互娱文化科技有限公司", desc: "北京市朝阳区将台路诺金中心写字楼1705室", color: "red", icon: "cir", offset: { x: -9, y: -31 }, lnglat: { lng: 116.481413, lat: 39.977288 } }];

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:98:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\public/../application/index\view\user\jobs_kw.html";i:1541306395;s:90:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\index\view\layout\default.html";i:1541305992;}*/ ?>
<!DOCTYPE html >
<html>
<head>
    ...
    <![endif]-->
		...
		<div class="container">
			...
			<div class="main voucher">
				<div class="job_div">
					<img src="/kewei/images/jobs.png" alt=""/>
				</div>
				<table cellpadding="0" cellspacing="0" class="jobs_tb">
					<tr class="jobs_tr1">
						<td>职位</td>
						<td>工作地点</td>
						<td>薪资</td>
					...
					<tr class="jobs_tr2">
						<td class="colblue"><a href="jobs.html?id=<?php echo $k['id']; ?>"><?php echo $k['name']; ?></a></td>
						<td><?php echo $k['nickname']; ?></td>
						<td><?php echo $k['diyname']; ?></td>
						<td><?php echo date("y/m/d H:i:s",$k['createtime']); ?></td>
						<td class="colblue"><a href="jobs.html?id=<?php echo $k['id']; ?>"> >> </a></td>
					</tr>
                    <?php endforeach; ?>
				</table>

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:99:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\public/../application/admin\view\category8\add.html";i:1541304798;s:90:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\admin\view\layout\default.html";i:1536636086;s:87:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\admin\view\common\meta.html";i:1536636086;s:89:"C:\phpStudy\PHPTutorial\WWW\1.0.0.20180911_full\application\admin\view\common\script.html";i:1536636086;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-name" data-rule="required" class="form-control editor" name="row[name]" ></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="c-nickname" class="control-label col-xs-12 col-sm-2"><?php echo __('愿景'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-nickname" data-rule="required" class="form-control editor" name="row[nickname]"  ></textarea>
        </div>
    </div>

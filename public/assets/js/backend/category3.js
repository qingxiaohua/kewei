define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'category3/index',
                    add_url: 'category3/add',
                    edit_url: 'category3/edit',
                    del_url: 'category3/del',
                    multi_url: 'category3/multi',
            ...
            var tableOptions = {
                ...
                columns: [
                    [
                        ...
                        {field: 'tt', title: __('标题'), align: 'left'},
                        //{field: 'nickname', title: __('URL')},
                        {field: 't_2', title: __('所属类别'), operate: false},
